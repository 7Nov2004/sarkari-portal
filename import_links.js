...
const data = [
  ...
  // Others
  { title: 'बैंक बैलेंस चेक (कॉल या मैसेज से )', category: 'SARKARI_KAAM', shortDescription: 'मिस्ड कॉल या SMS के जरिए अपने बैंक का बैलेंस চেক करें।' },
...
async function main() {
  ...
  for (const item of data) {
    // Basic slug generation for hindi titles using random timestamp for safety
